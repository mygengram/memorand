            ...
            <div class="row" >
                ...
                <div class="col-10">
                    <div class="row">
                        ...
                        <button type="button" class="btn btn-secondary btn-lg me-4 mt-4 float-start text-white custom-size-b1" ><svg  width="60" height="60" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm0 22C6.5 22 2 17.5 2 12S6.5 2 12 2s10 4.5 10 10-4.5 10-10 10z" fill="#62646a" class="fill-000000"></path><path d="M13.9 12.5c0-.2.1-.3.1-.5 0-.7-.4-1.4-1-1.7V4c0-.6-.4-1-1-1s-1 .4-1 1v6.3c-.6.3-1 1-1 1.7 0 1.1.9 2 2 2 .2 0 .3 0 .5-.1l1.8 1.8c.4.4 1 .4 1.4 0s.4-1 0-1.4l-1.8-1.8zM12 13c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z" fill="#62646a" class="fill-000000"></path><circle cx="20" cy="12" r="1" fill="#62646a" class="fill-000000"></circle><circle cx="4" cy="12" r="1" fill="#62646a" class="fill-000000"></circle><circle cx="17.7" cy="17.7" r="1" fill="#62646a" class="fill-000000"></circle><circle cx="6.3" cy="6.3" r="1" fill="#62646a" class="fill-000000"></circle><circle cx="12" cy="20" r="1" fill="#62646a" class="fill-000000"></circle><circle cx="6.3" cy="17.7" r="1" fill="#62646a" class="fill-000000"></circle><circle cx="17.7" cy="6.3" r="1" fill="#62646a" class="fill-000000"></circle></svg><br>HORARIO</button>
