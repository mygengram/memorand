...
<div class="container">
    ...
    <div class="row  mb-3 text-center">
        ...
        <div class="col-4">
            <div class="card mb-4 border-primary rounded-3 shadow-sm mx-5 ">
                <div class="card-header py-3" style="background-color: #3ba79c;">
                    <h3 class="my-0 fw-normal text-white"><i class="bi bi-stars" style="color: yellow;"></i><b>  Pro  </b><i class="bi bi-stars" style="color: yellow;"></i></h3>
                </div>
                <div class="card-body">
                    <h5 class="card-title pricing-card-title">$57.00<small class="text-body-secondary fw-light">/mes</small> | $289.00<small class="text-body-secondary fw-light">/a&ntilde;o</small></h5>
                    <ul class="list-unstyled mt-3 mb-4 text-justify text-start mx-5">
                    ...
                    <button type="button" class="w-100 btn btn-lg custom-bsign ">Comenzar</button>
                </div>
            </div>
        </div>
        <div class="col-2"></div>
